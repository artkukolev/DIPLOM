...
export const StudentFormPage: React.FC = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    const instance: Student = {
      ...
      snils: existingStudent?.snils ?? "",
      passportSeries: existingStudent?.passportSeries ?? "",
      passportNumber: existingStudent?.passportNumber ?? "",
      address: existingStudent?.address ?? "",
      contactPhone: existingStudent?.contactPhone ?? "",
      ...
      specialNeeds: existingStudent?.specialNeeds ?? "нет",
      benefits: values.benefits ?? "",
      competencies: existingStudent?.competencies ?? [],
      portfolio: existingStudent?.portfolio ?? [],
      documents: existingStudent?.documents ?? [],
      history: existingStudent?.history ?? [],
